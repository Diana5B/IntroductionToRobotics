...
const int splitValue = 4;  //valoare folosita pentru a ajusta gama de valori citite de la potentiometre

void setup() {
	Serial.begin(9600); // pornirea comunicării seriale
}
...
void loop() {
  ...
  // afisarea valorii rosii pe consola seriala (pentru monitorizare)
